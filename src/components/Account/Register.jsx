    ...
    <section className=" flex items-center justify-center h-screen" style={{ backgroundImage: `url('./src/assets/veg.jpg')`}} >
      <div class="bg-white p-8 rounded-xl shadow-lg w-full max-w-md">
            ...
            <form action="#" method="POST">
                ...
                <button type="submit" class="w-full bg-green-800 text-white py-2 rounded-lg hover:bg-green-600 focus:outline-none focus:ring-2 focus:ring-green-500">Sign Up</button>
            </form>
            <div>
                <div>
                ...
                <div>
                    <h3 class="text-center py-3 text-gray-700">Already have an account? <span class="text-green-800"><Link to="/signin">Login</Link></span></h3>
                </div>
            </div>
        </div>  
    </section> 
